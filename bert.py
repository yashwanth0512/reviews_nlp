...
# Reference summaries stored in a dictionary
reference_summaries = {
...
# Generated summaries (from your model) stored in a dictionary
generated_summaries = {
...
# Convert dictionary values to lists before passing to BERTScore
